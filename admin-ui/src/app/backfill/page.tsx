                    ...
                    <form className="space-y-4 flex flex-col flex-1">
                        <div>
                            ...
                            <div className="flex gap-2">
                                <input type="date" className="border rounded px-3 py-2 w-1/2 text-black" />
                                <input type="date" className="border rounded px-3 py-2 w-1/2 text-black" />
                            </div>
                        </div>
                        <div>
                        ...
                        <div>
                            <label className="block text-sm font-medium text-black mb-1">Enqueue Type</label>
                            <select className="border rounded px-3 py-2 w-full text-black">
                        ...
                        <button className="w-full py-2 rounded font-semibold transition mt-auto" style={{ backgroundColor: '#3E5973', color: 'white' }}>
                            Submit
                        </button>
                    </form>
                </div>
                ...
                <div className="bg-white shadow-lg rounded-xl border border-gray-100 p-6 mb-6 flex flex-col h-full">
                    ...
                    <form className="space-y-4 flex flex-col flex-1">
                        <div>
                            ...
                            <input type="number" className="border rounded px-3 py-2 w-full text-black" />
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-black mb-1">Enqueue Type</label>
                            <select className="border rounded px-3 py-2 w-full text-black">
